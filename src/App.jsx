        ...
        <section id="home" className="hero observed-section">
          ...
          <div className="container hero-inner">
            <div className="hero-copy">
              <h1>陈定市</h1>
              <div className="english-name">DINGSHI CHEN</div>
              <p className="hero-role">土木工程博士 · 桥梁工程与混凝土耐久性研究者</p>
              <p className="hero-description">
                聚焦复杂环境下混凝土结构耐久性、桥梁全寿命评估与多尺度数值模拟，连接科学研究与重大工程实践。
              </p>
              <div className="hero-actions">
                <button className="primary-button" onClick={() => scrollTo('publications')}>
                  查看研究成果 <ArrowRight size={18} />
                </button>
            ...
            <div className="portrait-stage" aria-label="陈定市个人照片">
              <HeroBridge />
